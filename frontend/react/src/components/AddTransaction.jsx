    ...
    const handleSubmit = (e) => {
        ...
        if (!text || !amount) {
          ...
          if (amountValue < 0 && totalIncome - amountValue < 0) {
            setError(
              `Expense cannot exceed available savings or income. Current savings: ₹ ${totalSavings.toFixed(2)}`
            );
            return;
          }

          // Validation for 0 savings and expenses
